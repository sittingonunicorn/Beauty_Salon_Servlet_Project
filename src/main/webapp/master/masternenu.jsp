...
<nav class="menu">
    <ul class="hr">
        <li><a href="${pageContext.request.contextPath}/app/master/comments"><fmt:message
                key="link.comments"/></a></li>
        <li><a href="${pageContext.request.contextPath}/app/master/appointments"><fmt:message
